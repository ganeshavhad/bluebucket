                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Drink Type Form</strong> Elements
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="<?php echo base_url('Submit/DrinkType');?>" method="post" enctype="multipart/form-data"  class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3"><label class=" form-control-label">DRINK TYPE</label></div>
                                                <div class="col-12 col-md-9">
                                                  <input type="text" id="text-input" name="DRINK_TYPE" placeholder="Text" class="form-control">
                                                </div>
                                            </div>
                                           <!--  <div class="row form-group">
                                      ...
                                      -->
                                         <!--    <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9"><input type="file" id="file-input" name="DRINK_TYPE_IMG" class="form-control-file"></div>
                                            </div>
                                           <!--   <div class="row form-group">
