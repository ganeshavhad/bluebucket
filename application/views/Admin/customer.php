            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody><?php foreach($customer as $value){  ?>
                      <tr>
                        <td><?php print_r($value->CUSTOMER_NAME);?></td>
                        <td><?php print_r($value->CUSTOMER_MOBILE_NUMBER);?></td>
                        <td><?php print_r($value->CUSTOMER_ADDRESS);?></td>
                        <td><?php print_r($value->CUSTOMER_EMAIL_ID);?></td>
